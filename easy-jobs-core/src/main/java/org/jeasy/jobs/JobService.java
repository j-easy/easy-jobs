...
class JobService {
    ...
    JobService(ExecutorService executorService, JobExecutionDAO jobExecutionDAO, JobRequestDAO jobRequestDAO, TransactionTemplate transactionTemplate, JobFactory jobFactory) {
